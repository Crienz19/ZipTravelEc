...
<header class="program-header" style="background-image: url('{{ asset("assets/img/TRAINEE.jpg") }}');background-size: cover;background-position: top;background-repeat: no-repeat;"></header>
    <section class="p-5">
    ...
    <section class="section-blue">
        <div class="container-fluid">
            ...
            <div class="row mt-3">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3 d-flex justify-content-center align-items-center">
                    <div class="d-xl-flex flex-column justify-content-xl-center align-items-xl-center z-card"><img src="{{ asset('assets/img/contract.png') }}" width="120px">
