...
<head>
    ...
    <meta property="og:image" content="assets/img/J1%20PROGRAMS-1.jpg">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="ZIP Travel Philippines">
    <link rel="icon" type="image/png" sizes="1944x1944" href="assets/img/LOGO_ZIP.png">
    <link rel="icon" type="image/png" sizes="1944x1944" href="assets/img/LOGO_ZIP.png">
...
<body>
        ...
        <div class="container-fluid">
            <div class="row" style="margin-bottom: 35px;">
                <div class="col">
                    <div>
                        ...
                        <p class="text-justify text-lg-center text-xl-center">We provide intercultural opportunities to foreign students to help them become familiar with U.S technologies through different types of U.S.-based training. We help them obtain a better understanding of one another and the world
                            around them.<br></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 col-md-3 text-center d-xl-flex justify-content-xl-center align-items-xl-center">
                    <div class="what-we-do-item"><img src="assets/img/customer.png">
                        <p>27 Years of Service</p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-3 text-center d-xl-flex justify-content-xl-center align-items-xl-center">
                    <div class="what-we-do-item"><img src="assets/img/team-leader.png">
                        <p>54,570+ Students and Alumni</p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-3 text-center d-xl-flex justify-content-xl-center align-items-xl-center">
                    <div class="what-we-do-item"><img src="assets/img/ZIP%20Resume%20Template%20(2).png">
                        <p>High Visa Approval Rate</p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-3 text-center d-xl-flex justify-content-xl-center align-items-xl-center">
                    <div class="what-we-do-item"><img src="assets/img/usa-flag.png">
    ...
    <section class="d-flex d-xl-flex align-items-xl-center section-with-image" data-bs-parallax-bg="true" style="background-image: url(&quot;assets/img/ABOUT%20US.jpg&quot;);background-size: cover;background-position: center;background-repeat: no-repeat;">
    ...
    <div class="carousel slide" data-ride="carousel" data-keyboard="false" id="carousel-2">
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active slide-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col text-center img-container"><img src="assets/img/LOGO_MARRIOTT.png"></div>
                        <div class="col text-center img-container"><img src="assets/img/LOGO_COURTYARD.png"></div>
                        <div class="col text-center img-container"><img src="assets/img/LOGO_FAIRMONT.png"></div>
                        <div class="col text-center img-container"><img src="assets/img/LOGO_HYATT.png"></div>
                        <div class="col text-center img-container"><img src="assets/img/LOGO_RENAISSANCE.png"></div>
                        <div class="col text-center img-container"><img src="assets/img/LOGO_HOWARD.png"></div>
                    </div>
                </div>
            </div>
            <div class="carousel-item slide-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col text-center img-container"><img src="assets/img/LOGO_GAYLORD.png"></div>
                        <div class="col text-center img-container"><img src="assets/img/LOGO_OMNI.png"></div>
                        <div class="col text-center img-container"><img src="assets/img/LOGO_HILTON.png"></div>
                        <div class="col text-center img-container"><img src="assets/img/LOGO_JWMARRIOTT.png"></div>
                        <div class="col text-center img-container"><img src="assets/img/LOGO_FOURSEASONS.png"></div>
                        <div class="col text-center img-container"><img src="assets/img/LOGO_MOHEGAN-1.png"></div>
                    </div>
                </div>
            </div>
        </div>
