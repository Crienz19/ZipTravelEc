...
<header class="program-header" style="background-image: url('{{ asset("assets/img/SWT-1.jpg") }}');background-size: cover;background-repeat: no-repeat;background-position: center;"></header>
    <section class="p-5">
        ...
        <div class="container-fluid">
            ...
            <div class="row mt-3">
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-4 d-xl-flex justify-content-xl-center align-items-xl-center">
                    <div class="z-card"><img src="{{ asset('assets/img/plus-18-movie.png') }}">
                        <p class="text-white" style="margin-top: 15px;">Must be at least 18 years old</p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-4 d-xl-flex justify-content-xl-center align-items-xl-center">
                    <div class="z-card"><img src="{{ asset('assets/img/student.png') }}" width="120px">
