    ...
    <section class="section">
        <form method="/sendInquiry">
            <div class="container-fluid">
                ...
                <div class="form-row">
                    <div class="col-6">
                        <div class="form-group"><label>FULLNAME (Required)</label><input class="form-control" type="text" name="full_name" placeholder="Enter your fullname here..."></div>
                    </div>
                    <div class="col-6">
                        <div class="form-group"><label>E-MAIL (Required)</label><input class="form-control" type="text" name="email" placeholder="Enter your email here..."></div>
                    </div>
                    <div class="col-12">
                        <div class="form-group"><label>Message:</label><textarea class="form-control" rows="10" name="message" placeholder="Enter your message here..."></textarea></div>
